...
for i = 1:ncols*nrows
    ...
    figure(h1);
    axes(ax1(i));
    p1 = polarscatter(Phase1(:,1), Harm1(:,1), 10, 'filled',...
    ...
    hold on;
    p2 = polarscatter(Phase1(:,2), Harm1(:,2), 10, 'filled',...
        'MarkerEdgeColor','none', 'MarkerFaceColor',clr(2,:),...
        'MarkerFaceAlpha',0.3); % First harmonic 
    p3 = polarscatter(Phase1(:,3), Harm1(:,3), 10, 'filled',...
        'MarkerEdgeColor','none', 'MarkerFaceColor',clr(3,:).^2,...
        'MarkerFaceAlpha',0.3); % First harmonic 

    figure(h2);
    axes(ax2(i));
    p1 = polarscatter(Phase2(:,1), Harm2(:,1), 10, 'filled',...
        'MarkerEdgeColor','none', 'MarkerFaceColor',clr(1,:).^2,...
        'MarkerFaceAlpha',0.3); % First harmonic 
    set(gca, 'RLim',[0 6]);
    if i==1
    ...
    hold on;
    p2 = polarscatter(Phase2(:,2), Harm2(:,2), 10, 'filled',...
        'MarkerEdgeColor','none', 'MarkerFaceColor',clr(2,:),...
        'MarkerFaceAlpha',0.3); % First harmonic 
    p3 = polarscatter(Phase2(:,3), Harm2(:,3), 10, 'filled',...
        'MarkerEdgeColor','none', 'MarkerFaceColor',clr(3,:).^2,...
        'MarkerFaceAlpha',0.3); % First harmonic 
